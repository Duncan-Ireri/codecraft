...
Revision ID: 869254f8d50e
Revises: 
Create Date: 2022-12-27 03:24:06.623546
...
def upgrade():
    ...
    sa.Column('email_to_share', sa.String(length=255), nullable=True),
    sa.Column('reason_for_sms', sa.Text(), nullable=True),
